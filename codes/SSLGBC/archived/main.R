...
################################# Get the lambdastar
get_lambdastarR <- function(x, thetas, lambdas) {
...
get_thetasR <- function(mat, a, b, tol = 0){
...
get_logLikelihoodR <- function(Y, A, B, tilde_thetas, thetas, tilde_lambdas, lambdas, tilde_alpha, tilde_beta, alpha, beta){
...
################################# Main function
SSLGBC <- function(Y, A = NULL, B = NULL, xi = 1, mu = NULL, 
